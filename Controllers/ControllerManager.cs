        ...
        void Update() {
            ...
            if(CurrentCameraController != null) {
                ...
                if(zoomTarget == null) {
                    ...
                    if(MapManager.instance.currentMap != null && MapManager.instance.currentMap.Map.size != 0f) { zoomTarget = MapManager.instance.currentMap.Map.size; } else { zoomTarget = DefaultZoom; }
                }
